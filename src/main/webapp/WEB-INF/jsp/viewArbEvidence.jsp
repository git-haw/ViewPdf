...
<head>
<title>证据预览</title>
<link rel="stylesheet" href="${pageContext.request.contextPath}/pdfviewer/css/viewer.css" />
<script src="${pageContext.request.contextPath}/js/jquery-1.11.1.min.js"></script>
<script src="${pageContext.request.contextPath}/pdfviewer/js/compatibility.js"></script>

<link rel="resource" type="application/l10n" href="${pageContext.request.contextPath}/locale/locale.properties" />
<script src="${pageContext.request.contextPath}/pdfviewer/js/l10n.js"></script>
<script src="${pageContext.request.contextPath}/pdfviewer/js/pdf.js"></script>
<script src="${pageContext.request.contextPath}/pdfviewer/js/debugger.js"></script>
<script src="${pageContext.request.contextPath}/pdfviewer/js/viewer.js"></script>
</head>
...
<div id="outerContainer">
	...
	<!-- sidebarContainer -->
	<input type="hidden" id="default_url" name="default_url">
...
<script type="text/javascript">
	//通过流方式预览证据
	DEFAULT_URL  = '${pageContext.request.contextPath}/viewpdf/fetchFile.shtml';
	$.post(DEFAULT_URL);
	PDFJS.workerSrc = "${pageContext.request.contextPath}/pdfviewer/js/pdf.worker.js";
</script>
</body>
</html>